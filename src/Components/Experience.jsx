...
const Experience = () => {
    const technologies = [
        ...
        { id: 1, src: logo3, title: 'PYTHON', style: 'shadow-yellow-700' },
        { id: 2, src: logo1, title: 'HTML', style: 'shadow-orange-500' },
        { id: 3, src: logo2, title: 'CSS', style: 'shadow-blue-500' },
        { id: 4, src: js, title: 'JS', style: 'shadow-purple-500' },
        { id: 5, src: reacticon, title: 'REACT', style: 'shadow-purple-500' },
        { id: 6, src: logo5, title: 'REDUX', style: 'shadow-purple-800' },
        { id: 7, src: logo6, title: 'NODE', style: 'shadow-green-400' },
