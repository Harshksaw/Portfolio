...
const ReviewCard = ({
    ...
    return (
      ...
      >
        <div className="flex flex-row relative w-24 items-center justify-center p-2 bg-gradient-to-br from-white/90 to-gray-100/80 h-20 rounded-3xl border border-primary-main/30 shadow-[0_4px_16px_rgba(18,113,255,0.2)]">
